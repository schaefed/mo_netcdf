program test_write
  ...
  !! i.e. (5,5)
  call var%setData(42, start=[5,5,1])
  call nc%sync()
  ...
  !! i.e. (:,1,3)
  x = 21
  call var%setData(x, start=[1,1,3])
  call nc%sync()
  ...
  !! i.e. (3,:,6)
  y = 84
  call var%setData(y, start=[3,1,6], cnt=[1,ny])
  call nc%sync()
  ...
  !! i.e. (:,:,4)
  tstep = 168
  call var%setData(tstep, start=[1,1,4])
  call nc%sync()
  ...
  !! (4,6,1::2)
  time = 336
  call var%setData(time, start=[6,4], cnt=[1,1,ntime], stride=[1,1,2] )
  call nc%sync()
